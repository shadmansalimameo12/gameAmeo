    ...
    return (
        <div>
            ...
            <div className='w-2/3 mx-auto bg-gray-100 p-6'>
                ...
                <div className="my-3 w-full border-t border-dashed border-gray-400"></div>
                <p className='text-[#FFA000] bg-[#FFA00020] rounded-3xl p-1'> !  Due to high patient volume, we are currently accepting appointments for today only. We appreciate your understanding and cooperation.</p>
